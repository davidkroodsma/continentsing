...
header_text = '''<h2><a href="search.php#species-list"><span class="i-bird"></span></a> BIRDNAME <span class="rec-number"><a href="search.php#number-list"><span class="i-number"></span></a> KEY</span></h2>				
